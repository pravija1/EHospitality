...
urlpatterns +=[
    ...
    path('doctor-prescribe-patient/', views.doctor_prescribe_patient_view, name='doctor-prescribe-patient'),
    path('prescribe-patient/<int:pk>', views.prescribe_patient_view, name='prescribe-patient'),

    path('doctor-view-discharge-patient',views.doctor_view_discharge_patient_view,name='doctor-view-discharge-patient'),
    path('download-prescription-pdf/<int:pk>', views.download_prescription_pdf_view, name='download-prescription-pdf'),
...
urlpatterns +=[
    ...
    # Paths for managing departments
